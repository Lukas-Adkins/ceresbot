...
4. Add a spells.json project file at `src/main/resources/spells.json` with the [following schema](https://cdn.discordapp.com/attachments/363199559054393357/1067256900409893015/image.png).
